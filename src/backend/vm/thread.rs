...
impl<'a> FSRThreadRuntime<'a> {
    ...
    fn load_list(
        ...
        if let ArgType::LoadListNumber(n) = bytecode.get_arg() {
            ...
            let list = self
                .garbage_collect
                .new_object(FSRList::new_value(list), get_object_by_global_id(FSRGlobalObjId::ListCls) as ObjId);
    ...
    fn load_const(&mut self, arg: &'a BytecodeArg) -> Result<bool, FSRError> {
        ...
        match arg.get_arg() {
            ...
            ArgType::ConstString(index, s) => {
                ...
                // obj.ref_add();
                let obj = FSRObject::new_inst(obj, get_object_by_global_id(FSRGlobalObjId::StringCls));
