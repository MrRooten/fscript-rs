use crate::ast::{SyntaxError, parse::ASTParser, token::expr::FSRExpr};
...
impl FSRListFrontEnd {
    ...
    pub fn parse(source: &[char], meta: FSRPosition, context: &mut ASTContext) -> Result<FSRListFrontEnd, SyntaxError> {
